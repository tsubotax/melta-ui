...
| **contracts/** | JSON | AI + harness | Strict spec: 40 contracts (28 web) + 99 rules + 99 tokens |
...
| LLM-judge candidate | 0 (0 error) | `llm-judge-candidate` (no automated verification until the shadow judge ships) |
| Human-only | 0 (0 error) | Guarded by human review only; surfaced to the AI via `get_rules` |
| Unclassified | 54 (42 error) | Inventory pending (no automationStatus declared) |
<!-- END:coverage-en -->
